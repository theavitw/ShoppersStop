...
function Navbar() {
  document.addEventListener("DOMContentLoaded", function () {
    ...
    searchIcon.addEventListener("click", function () {
      searchInput.classNameList.toggle("active");
      if (searchInput.classNameList.contains("active")) {
        searchInput.focus();
      }
    });
  });
  ...
  return (
    <div className="header-container">
      ...
      <div className="categories">
        <div className="category">Jewelry & Accessories</div>
        <div className="category">Clothing & Shoes</div>
        <div className="category">Home & Living</div>
        <div className="category">Wedding & Party</div>
        <div className="category">Toys & Entertainment</div>
        <div className="category">Art & Collectibles</div>
        <div className="category">Craft Supplies & Tools</div>
      </div>
    </div>
  );
}
